This is a patch for the game client "Metal Rage Online" to get it to run on Windows 11. 
...
Client & Installer files avaliable [Here]([https://www.mysql.com/](https://archive.org/download/metal-rage-online-client/MetalRage%20Online/)).
